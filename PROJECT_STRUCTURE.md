...
├── ml_model/                      # ML model files (future enhancement)
│   ├── model.pkl                  # Trained ML model (placeholder)
│   └── vectorizer.pkl             # TF-IDF vectorizer (placeholder)
├── static/
│   ├── css/
...
- **JavaScript**: Handles API communication and results display
